...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TestCase.has_csv'
        db.add_column(u'threedi_verification_testcase', 'has_csv',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TestCase.has_csv'
        db.delete_column(u'threedi_verification_testcase', 'has_csv')
