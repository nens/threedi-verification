...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TestCase.library'
        db.add_column(u'threedi_verification_testcase', 'library',
                      self.gf('django.db.models.fields.CharField')(default=u'SUBG', max_length=4),
                      keep_default=False)

        # Adding field 'LibraryVersion.library'
        db.add_column(u'threedi_verification_libraryversion', 'library',
                      self.gf('django.db.models.fields.CharField')(default=u'SUBG', max_length=4),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TestCase.library'
        db.delete_column(u'threedi_verification_testcase', 'library')

        # Deleting field 'LibraryVersion.library'
        db.delete_column(u'threedi_verification_libraryversion', 'library')
